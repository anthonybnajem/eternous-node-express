...
const objectId = (value: string, helpers: Joi.CustomHelpers): string | Joi.ErrorReport => {
...
const password = (value: string, helpers: Joi.CustomHelpers): string | Joi.ErrorReport => {
  if (value.length < 8) {
